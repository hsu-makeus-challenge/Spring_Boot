...
public class QStore extends EntityPathBase<Store> {
    ...
    public final ListPath<BusinessHours, QBusinessHours> businessHoursList = this.<BusinessHours, QBusinessHours>createList("businessHoursList", BusinessHours.class, QBusinessHours.class, PathInits.DIRECT2);
