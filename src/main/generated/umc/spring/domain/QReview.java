...
public class QReview extends EntityPathBase<Review> {
    ...
    public final ListPath<ReviewRely, QReviewRely> reviewRelyList = this.<ReviewRely, QReviewRely>createList("reviewRelyList", ReviewRely.class, QReviewRely.class, PathInits.DIRECT2);
