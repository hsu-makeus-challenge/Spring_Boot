...
public class MemberMissionExistByMissionValidator implements ConstraintValidator<MemberMissionExistByMission, Long> {
    ...
    @Override
    public void initialize(MemberMissionExistByMission constraintAnnotation) {
