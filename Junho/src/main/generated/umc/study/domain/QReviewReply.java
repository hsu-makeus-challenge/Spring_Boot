...
public class QReviewReply extends EntityPathBase<ReviewReply> {
    ...
    private static final long serialVersionUID = -1464246224L;
    ...
    public final umc.study.domain.mapping.QReview review;
    ...
    public QReviewReply(Class<? extends ReviewReply> type, PathMetadata metadata, PathInits inits) {
        ...
        this.review = inits.isInitialized("review") ? new umc.study.domain.mapping.QReview(forProperty("review"), inits.get("review")) : null;
    }
